...
DEFAULT_ARCHIVE_URL = 'https://github.com/statsbomb/open-data/archive/refs/heads/master.zip'


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Download and extract StatsBomb Open Data from GitHub.')
...
def main() -> int:
    ...
    archive_path = archive_dir / 'statsbomb_open_data.zip'
    repo_root = extract_dir / 'open-data-master'
